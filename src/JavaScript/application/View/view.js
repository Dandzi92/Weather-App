...
export default class View {
  constructor() {
    ...
    if (this.initDegreeUnit === 'f') { document.querySelector('.header--temperature_fahrenheit').classList.add('degrees_unit_active'); } else { document.querySelector('.header--temperature_celsius').classList.add('degrees_unit_active'); }
  }
